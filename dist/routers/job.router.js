...
router.get("/categories", job_controller_1.getAllCategoriesHandler);
...
router.get("/:id/is-saved", auth_middleware_1.VerifyToken, job_controller_1.checkIsJobSavedHandler);
router.post("/:id/save", auth_middleware_1.VerifyToken, job_controller_1.saveJobHandler);
router.delete("/:id/save", auth_middleware_1.VerifyToken, job_controller_1.removeSavedJobHandler);
router.post("/:id/apply", auth_middleware_1.VerifyToken, (0, multer_1.Multer)().single("resume"), job_controller_1.applyJobHandler);
